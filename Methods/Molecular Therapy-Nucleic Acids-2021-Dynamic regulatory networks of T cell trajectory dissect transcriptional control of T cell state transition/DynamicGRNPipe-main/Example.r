...
C1_C2_cross <- densityintersection(a=cellInfor[cellInfor$majorCluster=="CD8_C1-LEF1","PseTime.Lineage1"], 
                                   b=cellInfor[cellInfor$majorCluster=="CD8_C2-CD28","PseTime.Lineage1"], 
                                   filename="C1_C2.pdf") 
C2_C4_cross <- densityintersection(a=cellInfor[cellInfor$majorCluster=="CD8_C2-CD28","PseTime.Lineage1"], 
                                   b=cellInfor[cellInfor$majorCluster=="CD8_C4-GZMK","PseTime.Lineage1"], 
                                   filename="C2_C4.pdf") 
C4_C5_cross <- densityintersection(a=cellInfor[cellInfor$majorCluster=="CD8_C4-GZMK","PseTime.Lineage1"], 
                                   b=cellInfor[cellInfor$majorCluster=="CD8_C5-ZNF683","PseTime.Lineage1"], 
                                   filename="C4_C5.pdf")
C5_C6_cross <- densityintersection(a=cellInfor[cellInfor$majorCluster=="CD8_C5-ZNF683","PseTime.Lineage1"], 
