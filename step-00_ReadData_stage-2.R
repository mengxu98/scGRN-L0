...
if (T) {
  ...
  PhilipBischoff2021_id <- c("31", "32", "19", "27", "34")
  ...
  # PhilipBischoff2021.P031 <- Read10X("/data/mengxu/data/PhilipBischoff2021/cellranger/p031t/filtered_feature_bc_matrix")
  #
  # PhilipBischoff2021.P031 <- CreateSeuratObject(counts = PhilipBischoff2021.P031,
  #                                               project = 'PhilipBischoff2021.P031',
  #                                               min.features = 200,
  #                                               min.cells = 3)
  #
  # PhilipBischoff2021.P031$platform <- '10X'
  # ###QC
  # PhilipBischoff2021.P031 <- PercentageFeatureSet(PhilipBischoff2021.P031, pattern = "^MT-", col.name = "pMT")
  # PhilipBischoff2021.P031 <- PercentageFeatureSet(PhilipBischoff2021.P031, pattern = "^HBA|^HBB", col.name = "pHB")
  # PhilipBischoff2021.P031 <- PercentageFeatureSet(PhilipBischoff2021.P031, pattern = "^RPS|^RPL", col.name = "pRP")
  # PhilipBischoff2021.P031<- subset(PhilipBischoff2021.P031,
  #                                  subset = nFeature_RNA > nFeature_lower &
  #                                    nFeature_RNA < nFeature_upper &
  #                                    nCount_RNA > nCount_lower &
  #                                    nCount_RNA < nCount_upper &
...
if (T) {
  ...
  DietherLambrechts2018.P08.1 <- Read10X("/data/mengxu/data/E-MTAB-6653/scrBT1425_hg19/scrBT1425_hg19_f/outs/filtered_feature_bc_matrix")

  DietherLambrechts2018.P08.1 <- CreateSeuratObject(
    counts = DietherLambrechts2018.P08.1,
    project = "DietherLambrechts2018.P08.1",
    min.features = 200,
    min.cells = 3
  )

  DietherLambrechts2018.P08.1$platform <- "10X"
  ### QC
  DietherLambrechts2018.P08.1 <- PercentageFeatureSet(DietherLambrechts2018.P08.1, pattern = "^MT-", col.name = "pMT")
  DietherLambrechts2018.P08.1 <- PercentageFeatureSet(DietherLambrechts2018.P08.1, pattern = "^HBA|^HBB", col.name = "pHB")
  DietherLambrechts2018.P08.1 <- PercentageFeatureSet(DietherLambrechts2018.P08.1, pattern = "^RPS|^RPL", col.name = "pRP")
  DietherLambrechts2018.P08.1 <- subset(DietherLambrechts2018.P08.1,
    subset =
  ...
  ###
  DietherLambrechts2018.P08.2 <- Read10X("/data/mengxu/data/E-MTAB-6653/scrBT1426_hg19/scrBT1426_hg19_f/outs/filtered_feature_bc_matrix")
  DietherLambrechts2018.P08.2 <- CreateSeuratObject(
    counts = DietherLambrechts2018.P08.2,
    project = "DietherLambrechts2018.P08.2",
    min.features = 200,
    min.cells = 3
  )
  DietherLambrechts2018.P08.2$platform <- "10X"
  ### QC
  DietherLambrechts2018.P08.2 <- PercentageFeatureSet(DietherLambrechts2018.P08.2, pattern = "^MT-", col.name = "pMT")
  DietherLambrechts2018.P08.2 <- PercentageFeatureSet(DietherLambrechts2018.P08.2, pattern = "^HBA|^HBB", col.name = "pHB")
  DietherLambrechts2018.P08.2 <- PercentageFeatureSet(DietherLambrechts2018.P08.2, pattern = "^RPS|^RPL", col.name = "pRP")
  DietherLambrechts2018.P08.2 <- subset(DietherLambrechts2018.P08.2,
    subset =
      nFeature_RNA > nFeature_lower &
        # nFeature_RNA < nFeature_upper &
        nCount_RNA > nCount_lower &
  ...
  ###
  DietherLambrechts2018.P08.3 <- Read10X("/data/mengxu/data/E-MTAB-6653/scrBT1427_hg19/scrBT1427_hg19_f/outs/filtered_feature_bc_matrix")
  DietherLambrechts2018.P08.3 <- CreateSeuratObject(
    counts = DietherLambrechts2018.P08.3,
    project = "DietherLambrechts2018.P08.3",
    min.features = 200,
    min.cells = 3
  )
  DietherLambrechts2018.P08.3$platform <- "10X"
  ### QC
  DietherLambrechts2018.P08.3 <- PercentageFeatureSet(DietherLambrechts2018.P08.3, pattern = "^MT-", col.name = "pMT")
  DietherLambrechts2018.P08.3 <- PercentageFeatureSet(DietherLambrechts2018.P08.3, pattern = "^HBA|^HBB", col.name = "pHB")
  DietherLambrechts2018.P08.3 <- PercentageFeatureSet(DietherLambrechts2018.P08.3, pattern = "^RPS|^RPL", col.name = "pRP")
  DietherLambrechts2018.P08.3 <- subset(DietherLambrechts2018.P08.3,
    subset =
      nFeature_RNA > nFeature_lower &
        # nFeature_RNA < nFeature_upper &
        nCount_RNA > nCount_lower &
  ...
  ###
  DietherLambrechts2018.P08 <- merge(DietherLambrechts2018.P08.1,
    y = c(
      DietherLambrechts2018.P08.2,
      DietherLambrechts2018.P08.3
    ),
    add.cell.ids = c(
...
if (T) {
  DietherLambrechts2018.P01.1 <- Read10X("/data/mengxu/data/E-MTAB-6149/BT1A/BT1A/outs/filtered_feature_bc_matrix")
  DietherLambrechts2018.P01.1 <- CreateSeuratObject(
    counts = DietherLambrechts2018.P01.1,
    project = "DietherLambrechts2018.P01.1",
    min.features = 200,
    min.cells = 3
  )
  DietherLambrechts2018.P01.1$platform <- "10X"
  ### QC
  DietherLambrechts2018.P01.1 <- PercentageFeatureSet(DietherLambrechts2018.P01.1, pattern = "^MT-", col.name = "pMT")
  DietherLambrechts2018.P01.1 <- PercentageFeatureSet(DietherLambrechts2018.P01.1, pattern = "^HBA|^HBB", col.name = "pHB")
  DietherLambrechts2018.P01.1 <- PercentageFeatureSet(DietherLambrechts2018.P01.1, pattern = "^RPS|^RPL", col.name = "pRP")
  DietherLambrechts2018.P01.1 <- subset(DietherLambrechts2018.P01.1,
    subset =
      nFeature_RNA > nFeature_lower &
        # nFeature_RNA < nFeature_upper &
        nCount_RNA > nCount_lower &
  ...
  ###
  DietherLambrechts2018.P01.2 <- Read10X("/data/mengxu/data/E-MTAB-6149/BT1B/BT1B/outs/filtered_feature_bc_matrix")
  DietherLambrechts2018.P01.2 <- CreateSeuratObject(
    counts = DietherLambrechts2018.P01.2,
    project = "DietherLambrechts2018.P01.2",
    min.features = 200,
    min.cells = 3
  )
  DietherLambrechts2018.P01.2$platform <- "10X"
  ### QC
  DietherLambrechts2018.P01.2 <- PercentageFeatureSet(DietherLambrechts2018.P01.2, pattern = "^MT-", col.name = "pMT")
  DietherLambrechts2018.P01.2 <- PercentageFeatureSet(DietherLambrechts2018.P01.2, pattern = "^HBA|^HBB", col.name = "pHB")
  DietherLambrechts2018.P01.2 <- PercentageFeatureSet(DietherLambrechts2018.P01.2, pattern = "^RPS|^RPL", col.name = "pRP")
  DietherLambrechts2018.P01.2 <- subset(DietherLambrechts2018.P01.2,
    subset =
      nFeature_RNA > nFeature_lower &
        # nFeature_RNA < nFeature_upper &
        nCount_RNA > nCount_lower &
  ...
  ###
  DietherLambrechts2018.P01.3 <- Read10X("/data/mengxu/data/E-MTAB-6149/BT1C/BT1C/outs/filtered_feature_bc_matrix")
  DietherLambrechts2018.P01.3 <- CreateSeuratObject(
    counts = DietherLambrechts2018.P01.3,
    project = "DietherLambrechts2018.P01.3",
    min.features = 200,
    min.cells = 3
  )
  DietherLambrechts2018.P01.3$platform <- "10X"
  ### QC
  DietherLambrechts2018.P01.3 <- PercentageFeatureSet(DietherLambrechts2018.P01.3, pattern = "^MT-", col.name = "pMT")
  DietherLambrechts2018.P01.3 <- PercentageFeatureSet(DietherLambrechts2018.P01.3, pattern = "^HBA|^HBB", col.name = "pHB")
  DietherLambrechts2018.P01.3 <- PercentageFeatureSet(DietherLambrechts2018.P01.3, pattern = "^RPS|^RPL", col.name = "pRP")
  DietherLambrechts2018.P01.3 <- subset(DietherLambrechts2018.P01.3,
    subset =
      nFeature_RNA > nFeature_lower &
        # nFeature_RNA < nFeature_upper &
        nCount_RNA > nCount_lower &
  ...
  ###
  DietherLambrechts2018.P01 <- merge(DietherLambrechts2018.P01.1,
    y = c(
      DietherLambrechts2018.P01.2,
      DietherLambrechts2018.P01.3
    ),
    add.cell.ids = c(
      "DietherLambrechts2018.P01",
      "DietherLambrechts2018.P01",
      "DietherLambrechts2018.P01"
    )
  )
  ...
  ###
  DietherLambrechts2018.P04.1 <- Read10X("/data/mengxu/data/E-MTAB-6149/BT1294/BT1294_f/outs/filtered_feature_bc_matrix")
  DietherLambrechts2018.P04.1 <- CreateSeuratObject(
    counts = DietherLambrechts2018.P04.1,
    project = "DietherLambrechts2018.P04.1",
    min.features = 200,
    min.cells = 3
  )
  DietherLambrechts2018.P04.1$platform <- "10X"
  ### QC
  DietherLambrechts2018.P04.1 <- PercentageFeatureSet(DietherLambrechts2018.P04.1, pattern = "^MT-", col.name = "pMT")
  DietherLambrechts2018.P04.1 <- PercentageFeatureSet(DietherLambrechts2018.P04.1, pattern = "^HBA|^HBB", col.name = "pHB")
  DietherLambrechts2018.P04.1 <- PercentageFeatureSet(DietherLambrechts2018.P04.1, pattern = "^RPS|^RPL", col.name = "pRP")
  DietherLambrechts2018.P04.1 <- subset(DietherLambrechts2018.P04.1,
    subset =
      nFeature_RNA > nFeature_lower &
        # nFeature_RNA < nFeature_upper &
        nCount_RNA > nCount_lower &
  ...
  ###
  DietherLambrechts2018.P04.2 <- Read10X("/data/mengxu/data/E-MTAB-6149/BT1295/BT1295_f/outs/filtered_feature_bc_matrix")
  DietherLambrechts2018.P04.2 <- CreateSeuratObject(
    counts = DietherLambrechts2018.P04.2,
    project = "DietherLambrechts2018.P04.2",
    min.features = 200,
    min.cells = 3
  )
  DietherLambrechts2018.P04.2$platform <- "10X"
  ### QC
  DietherLambrechts2018.P04.2 <- PercentageFeatureSet(DietherLambrechts2018.P04.2, pattern = "^MT-", col.name = "pMT")
  DietherLambrechts2018.P04.2 <- PercentageFeatureSet(DietherLambrechts2018.P04.2, pattern = "^HBA|^HBB", col.name = "pHB")
  DietherLambrechts2018.P04.2 <- PercentageFeatureSet(DietherLambrechts2018.P04.2, pattern = "^RPS|^RPL", col.name = "pRP")
  DietherLambrechts2018.P04.2 <- subset(DietherLambrechts2018.P04.2,
    subset =
      nFeature_RNA > nFeature_lower &
        # nFeature_RNA < nFeature_upper &
        nCount_RNA > nCount_lower &
  ...
  DietherLambrechts2018.P04.3 <- Read10X("/data/mengxu/data/E-MTAB-6149/BT1296/BT1296_f/outs/filtered_feature_bc_matrix")
  DietherLambrechts2018.P04.3 <- CreateSeuratObject(
    counts = DietherLambrechts2018.P04.3,
    project = "DietherLambrechts2018.P04.3",
    min.features = 200,
    min.cells = 3
  )
  DietherLambrechts2018.P04.3$platform <- "10X"
  ### QC
  DietherLambrechts2018.P04.3 <- PercentageFeatureSet(DietherLambrechts2018.P04.3, pattern = "^MT-", col.name = "pMT")
  DietherLambrechts2018.P04.3 <- PercentageFeatureSet(DietherLambrechts2018.P04.3, pattern = "^HBA|^HBB", col.name = "pHB")
  DietherLambrechts2018.P04.3 <- PercentageFeatureSet(DietherLambrechts2018.P04.3, pattern = "^RPS|^RPL", col.name = "pRP")
  DietherLambrechts2018.P04.3 <- subset(DietherLambrechts2018.P04.3,
    subset =
      nFeature_RNA > nFeature_lower &
        # nFeature_RNA < nFeature_upper &
        nCount_RNA > nCount_lower &
  ...
  ###
  DietherLambrechts2018.P04 <- merge(DietherLambrechts2018.P04.1,
    y = c(
      DietherLambrechts2018.P04.2,
      DietherLambrechts2018.P04.3
    ),
    add.cell.ids = c(
...
if (T) {
  ...
  # pHB_upper <- 5
  ###
  RapolasZilionis2019.P1.1 <- read.table("/data/mengxu/data/GSE127465/GSE127465/GSM3635278_human_p1t1_raw_counts.tsv.gz",
    row.names = 1,
    header = T
  )
  RapolasZilionis2019.P1.2 <- read.table("/data/mengxu/data/GSE127465/GSE127465/GSM3635279_human_p1t2_raw_counts.tsv.gz",
    row.names = 1,
    header = T
  )
  RapolasZilionis2019.P1.3 <- read.table("/data/mengxu/data/GSE127465/GSE127465/GSM3635280_human_p1t3_raw_counts.tsv.gz",
    row.names = 1,
    header = T
  )
  RapolasZilionis2019.P1.4 <- read.table("/data/mengxu/data/GSE127465/GSE127465/GSM3635281_human_p1t4_raw_counts.tsv.gz",
    row.names = 1,
    header = T
  )

  RapolasZilionis2019.P1 <- cbind.data.frame(
    t(RapolasZilionis2019.P1.1),
    t(RapolasZilionis2019.P1.2),
    t(RapolasZilionis2019.P1.3),
    t(RapolasZilionis2019.P1.4)
  )

  RapolasZilionis2019.P1 <- CreateSeuratObject(
    counts = RapolasZilionis2019.P1,
    project = "RapolasZilionis2019.P1",
    min.features = 200,
    min.cells = 3
  )
  RapolasZilionis2019.P1$platform <- "IndropSeq"
  ### QC
  RapolasZilionis2019.P1 <- PercentageFeatureSet(RapolasZilionis2019.P1, pattern = "^MT-", col.name = "pMT")
  RapolasZilionis2019.P1 <- PercentageFeatureSet(RapolasZilionis2019.P1, pattern = "^HBA|^HBB", col.name = "pHB")
  RapolasZilionis2019.P1 <- PercentageFeatureSet(RapolasZilionis2019.P1, pattern = "^RPS|^RPL", col.name = "pRP")
  RapolasZilionis2019.P1 <- subset(RapolasZilionis2019.P1,
    subset =
    # nFeature_RNA > nFeature_lower &
    # nFeature_RNA < nFeature_upper &
      nCount_RNA > nCount_lower &
...
if (F) {
  ...
  patient_ids <- c(
    "P370", "P522", "P581", "P581", "P584", "P584", "P522", "P714", "P729", "P408",
    "P570", "P695", "P706", "P706", "P706", "P706", "P706", "P706", "P706"
  )
  file_ids <- c(
    "2", "31", "48", "50", "51", "52", "245", "292", "308", "17",
    "42", "90", "343", "344", "345", "346", "347", "348", "351"
  )
...
if (T) {
  ...
  DiHe2021.T2 <- Read10X("/data/mengxu/data/CRA001963/CRR073023/CRR073023_f/outs/filtered_feature_bc_matrix")

  DiHe2021.T2 <- CreateSeuratObject(
    counts = DiHe2021.T2,
    project = "DiHe2021.T2",
    min.features = 200,
    min.cells = 3
  ...
  DiHe2021.T2$platform <- "10X"
  ### QC
  DiHe2021.T2 <- PercentageFeatureSet(DiHe2021.T2, pattern = "^MT-", col.name = "pMT")
  DiHe2021.T2 <- PercentageFeatureSet(DiHe2021.T2, pattern = "^HBA|^HBB", col.name = "pHB")
  DiHe2021.T2 <- PercentageFeatureSet(DiHe2021.T2, pattern = "^RPS|^RPL", col.name = "pRP")
  DiHe2021.T2 <- subset(DiHe2021.T2,
    subset =
    # nFeature_RNA > nFeature_lower &
    # nFeature_RNA < nFeature_upper &
      nCount_RNA > nCount_lower &
  ...
  DiHe2021.T5 <- Read10X("/data/mengxu/data/CRA001963/CRR073026/CRR073026_f/outs/filtered_feature_bc_matrix")

  DiHe2021.T5 <- CreateSeuratObject(
    counts = DiHe2021.T5,
    project = "DiHe2021.T5",
    min.features = 200,
    min.cells = 3
  ...
  DiHe2021.T5$platform <- "10X"
  ### QC
  DiHe2021.T5 <- PercentageFeatureSet(DiHe2021.T5, pattern = "^MT-", col.name = "pMT")
  DiHe2021.T5 <- PercentageFeatureSet(DiHe2021.T5, pattern = "^HBA|^HBB", col.name = "pHB")
  DiHe2021.T5 <- PercentageFeatureSet(DiHe2021.T5, pattern = "^RPS|^RPL", col.name = "pRP")
  DiHe2021.T5 <- subset(DiHe2021.T5,
    subset =
    # nFeature_RNA > nFeature_lower &
    # nFeature_RNA < nFeature_upper &
      nCount_RNA > nCount_lower &
...
samples <- c(
  PhilipBischoff2021_samples, # 5 samples
  "DietherLambrechts2018.P08",
  "DietherLambrechts2018.P01",
  "DietherLambrechts2018.P04",
  "RapolasZilionis2019.P1",
  "NayoungKim2020.P0009",
  # AndrewMLeader2021_samples, #19 samples
  "DiHe2021.T2",
  "DiHe2021.T5" # ,
  #' QianqianSong2019.P1' #,
  #' QianqianSong2019.P3',
  #' AshleyMLaughney2020.LX679'
)
#----------------------------------------------------------------------------------------------#

seu_obj_list <- c(
  PhilipBischoff2021, # list, 5 samples
  DietherLambrechts2018.P08,
  DietherLambrechts2018.P01,
  DietherLambrechts2018.P04,
  RapolasZilionis2019.P1,
  NayoungKim2020.P0009,
  # AndrewMLeader2021, #list, 19 samples
  DiHe2021.T2,
  DiHe2021.T5 # ,
  # QianqianSong2019.P1 #,
  # QianqianSong2019.P3,
  # AshleyMLaughney2020.LX679 #GSE123902
)

save(seu_obj_list, samples, file = "/data/mengxu/data/all/lung_stage-2_list_raw.Rdata")
#----------------------------------------------------------------------------------------#
rm(list = ls())
gc()
